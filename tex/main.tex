...
\subsection[Times Square]{Times Square\marginpar{\smash{\CODE{code/work/20210616-OPT1}}}}
\label{s:case1}
...
\subsection{Game-theoretic spin}
...
%
%
The taxi fare is $A \approx \SI{7}{\$}$ for short trips 
...
Comparing
$A$~vs.~$B + (e \times c)$
for each time-to-dollar factor $c$ from the income distribution
